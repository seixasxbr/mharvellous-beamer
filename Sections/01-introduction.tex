...
\begin{frame}[t]{Projeto Carcará}
    ...
    \begin{columns}
        ...
        \column{.49\textwidth}
        \vspace*{0.6cm}
        \includegraphics[trim = 600 0 450 0, clip, width=1\textwidth]{carcarareal.jpg}
        \column{.49\textwidth}
        \begin{itemize}
...
\begin{frame}[t]{Metodologia}
    \transdissolve[duration=0.5]
    \centering
    \includegraphics[trim = 0 200 0 0, clip, width=0.85\textwidth]{framework.png}
...
\begin{frame}[t]{Desafio da Linha de Pesquisa}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item Objetivo: Realizar seguimento de uma trajetória circular
            \item Framework: ROS Noetic
            \item Ambiente: Simulação (Gazebo)
            \item \url{https://github.com/Brazilian-Institute-of-Robotics/bir_aerial_challenge}
        \end{itemize}
        }
        \column{.01\textwidth}
    \end{columns}
...
\begin{frame}[t]{Desafio da Linha de Pesquisa}
    ...
    $\begin{bmatrix}
        ...
        =
        \begin{bmatrix}
        0,8\cdot sen(0,4\cdot t)\\ 
        0,8\cdot cos(0,4\cdot t)\\ 
        0,7+0,2\cdot cos(0,4\cdot t)\\
        0
        \end{bmatrix}$
%*----------- notes
    \note[item]{Notes can help you to remember important information. Turn on the notes option.}
...
\begin{frame}[t]{Desafio da Linha de Pesquisa}
    ...
    \includemedia[
      ...
      activate=pageopen,
      passcontext, 
      addresource=./Source/movies/challenge_drone.mp4,
      flashvars={
      source=./Source/movies/challenge_drone.mp4
      &autoPlay=true
      &autoRewind=true
      &Loop=true}
      ]{\fbox{\includegraphics{black}}}{VPlayer.swf}
...
\end{frame}
% %*----------- SLIDE -------------------------------------------------------------
% \begin{frame}[t]{Ferramentas de Auxílio}
%     \transdissolve[duration=0.5]
%     \begin{columns}
%         \column{.01\textwidth}
%         \column{.49\textwidth}
%         \vspace*{0.8cm}
%         \includegraphics[trim = 0 120 0 120, clip, width=1\textwidth]{mendeley.png}
%         \column{.49\textwidth}
%         \vspace*{0.8cm}
%         \includegraphics[trim = 30 0 30 0, clip, width=1\textwidth]{trello.png}
%         \column{.01\textwidth}
%     \end{columns}
